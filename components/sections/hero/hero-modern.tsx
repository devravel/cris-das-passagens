...
export function HeroModern({
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-6xl px-4 pb-16 pt-20 sm:px-6 sm:pb-20 sm:pt-24 lg:px-8 lg:pb-28 lg:pt-28">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <div className="flex flex-col gap-6 sm:gap-8">
            ...
            <motion.p
              className="mx-auto max-w-xl text-center text-base leading-relaxed text-muted-foreground sm:mx-0 sm:text-left sm:text-lg"
