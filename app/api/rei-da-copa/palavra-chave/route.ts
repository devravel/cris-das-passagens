...
import { dailyKeywordSubmissionSchema } from "@/lib/rei-da-copa/schemas";
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const parsed = dailyKeywordSubmissionSchema.safeParse(body);
    ...
    const submission = await reiDaCopaKeywordSubmissionsService.submitDailyKeyword(
      parsed.data,
    );
